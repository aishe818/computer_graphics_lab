...
const char *fragmentShader2Source = "#version 330 core\n"
    ...
    "void main()\n"
    "{\n"
    "   FragColor = vec4(0.0f, 1.0f, 1make.0f, 1.0f);\n"
    "}\n\0";
...
int main()
{
    ...
    unsigned int fragmentShaderRed=glCreateShader(GL_FRAGMENT_SHADER); // the first fragment shader that outputs the color Blue
    unsigned int fragmentShaderYellow = glCreateShader(GL_FRAGMENT_SHADER); // the second fragment shader that outputs the color Green
